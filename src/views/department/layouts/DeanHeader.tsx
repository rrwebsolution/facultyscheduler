            ...
            <AnimatePresence>
              {isProfileOpen && (
                <motion.div variants={dropdownVariants} initial="hidden" animate="visible" exit="exit" className="absolute right-0 mt-2 w-60 bg-popover rounded-md shadow-lg border z-50">
                  ...
                  <div className="p-1">
                    <Link to="/dean/profile" onClick={() => setIsProfileOpen(false)} className="w-full text-left flex items-center gap-2 px-2 py-1.5 text-sm rounded-sm hover:bg-muted"><User size={14} /> Profile</Link>
                    <Link to="/dean/settings" onClick={() => setIsProfileOpen(false)} className="w-full text-left flex items-center gap-2 px-2 py-1.5 text-sm rounded-sm hover:bg-muted"><Settings size={14} /> Settings</Link>
